...
class ObjectDetectorOptions(NamedTuple):
  ...
  label_allow_list: List[str] = ['cat', 'dog', 'backpack', 'handbag', 'suitcase','sports ball', 'bottle',
               'wine glass', 'cup', 'banana', 'apple', 'sandwich', 'orange', 'broccoli',
               'carrot', 'hot dog', 'pizza', 'donut', 'cake', 'laptop', 'mouse', 'remote',
               'keyboard', 'cell phone', 'book', 'hair drier', 'toothbrush']
...
class ObjectDetector:
  ...
  def _postprocess(self, boxes: np.ndarray, classes: np.ndarray,
    ...
    target_list = ['cat', 'dog', 'backpack', 'handbag', 'suitcase','sports ball', 'bottle',
               'wine glass', 'cup', 'banana', 'apple', 'sandwich', 'orange', 'broccoli',
               'carrot', 'hot dog', 'pizza', 'donut', 'cake', 'laptop', 'mouse', 'remote',
               'keyboard', 'cell phone', 'book', 'hair drier', 'toothbrush']
    ...
    for i in range(count):
      if scores[i] >= self._options.score_threshold:
        ...
        '''
        # For DDD Project by J.K.
        # To ignore person and print out when a big object detected
        
        detected_label = self._label_list[class_id]
                       
        tp=int(y_min * image_height)
        lt=int(x_min * image_width)
        bt=int(y_max * image_height)
        rt=int(x_max * image_width)

        if detected_label in target_list:
          if bt - tp > 150 or rt - lt > 150:

            print("It's something big")
          else:
